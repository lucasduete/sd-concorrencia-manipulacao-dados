...
public class LoaderWithBlockingQueueOffer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //1000 3  6755
        //1000 10 6065
        BlockingQueue<Integer> queueInsert = new ArrayBlockingQueue<>(3);
        BlockingQueue<Integer> queueUpdate = new ArrayBlockingQueue<>(3);
        BlockingQueue<Integer> queueDelete = new ArrayBlockingQueue<>(3);
        ...
        Runnable insertion = () -> {
            try {
                ...
                while (!queueUpdate.offer(localId));
        ...
        Runnable updation = () -> {
            try {
                ...
                while (!queueDelete.offer(localId));
            } catch (Exception ex) {
                ex.printStackTrace();
                return;
            }
